import { blogID, apiKey } from '../config/blogger.js';
  ...
  return [
    {
      ...
      image:  './categoryProducts/category-01.jpg',
      url:    `${encodeURIComponent('Crema para peinar')}`
    },{
      name:   'Línea cosmética',
      image:  './categoryProducts/category-04.jpg',
  ...
  return [
    {
      ...
      image:  './collectionProducts/collection-01.jpg',
      url:    `${encodeURIComponent('Productos destacados')}`
    },{
      name:   'Últimos productos',
      image:  './collectionProducts/collection-02.jpg',
